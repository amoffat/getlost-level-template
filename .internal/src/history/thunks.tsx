...
/**
 * Undo the most recent transaction on the given channel. No-op if empty.
 *
 ...
 */
export function undo(scope: string): Thunk {
...
/** Redo the most recently undone transaction on the given channel. */
export function redo(scope: string): Thunk {
  return (dispatch, getState) => {
