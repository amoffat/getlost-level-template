...
export interface TilesetDocV8 extends Omit<TilesetDocV7, "version"> {
  version: 8;
}

export interface TilesetDocV9 extends Omit<TilesetDocV8, "version"> {
  version: 9;
}

export interface TilesetDocV10 extends Omit<TilesetDocV9, "version"> {
  version: 10;
}

export type LatestTilesetDoc = TilesetDocV10;
